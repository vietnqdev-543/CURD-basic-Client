...
const HeaderAdmin = () => {
  ...
  return (
    <div>   
        ...
        <Col className='left' style={{backgroundColor:'#001529', color:'white', fontWeightL:'bold', display:'flex', justifyContent:'center', alignItems:'center' , width:'15%' ,minHeight:'100%' , textTransform:'uppercase' }}>
